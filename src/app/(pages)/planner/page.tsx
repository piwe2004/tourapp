...
function PlannerContent() {
    ...
    return (
        <div className="h-screen flex flex-col bg-slate-100 overflow-hidden">
            ...
            <header className="bg-white border-b border-slate-200 px-6 py-4 z-sticky shrink-0">
                <div className="max-w-[1920px] mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">{destination}</h1>
                        {travelContext?.tripSummary?.autoGeneratedTheme && (
                            <div className="bg-linear-to-br from-indigo-50 to-white text-primary border border-indigo-100 px-3 py-1.5 rounded-full text-[13px] font-semibold flex items-center gap-1.5 shadow-sm">
                    ...
                    <div className="flex items-center gap-4 bg-slate-50 px-4 py-2 rounded-lg border border-slate-100">
                        {!isSpotSearch && (
                            <>
                                <div className="flex items-center gap-2 text-slate-600 text-sm font-medium">
                                    <i className="fa-regular fa-calendar-days text-[14px] text-slate-400"></i>
                                    <span>
                        ...
                        <div className="flex items-center gap-2 text-slate-600 text-sm font-medium">
                            <i className="fa-solid fa-users text-[14px] text-slate-400"></i>
            ...
            {/* Main Content Area */}
            <main className="flex-1 flex overflow-hidden h-[calc(100vh-72px)]">
                {/* 1. 좌측 패널: Timeline(코스) vs PlaceList(장소검색) */}
                <div className="w-2/5 min-w-[400px] max-w-[600px] bg-slate-50 border-r border-slate-200 flex flex-col z-10 shadow-[4px_0_24px_rgba(0,0,0,0.04)] relative">
                    {isSpotSearch ? (
                        <PlannerPlaceList
