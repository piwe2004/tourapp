...
export default function PlannerTimeline({
    ...
    return (
        <section className="planner-timeline-panel">
            {/* 1. 날짜 선택 및 날씨 요약 위젯 */}
            <DaySelector 
                days={days}
                dateRange={dateRange}
            ...
            <div className="timeline-list-area custom-scrollbar">
                ...
                <button 
                    ...
                    className="add-schedule-btn group"
                >
                    <div className="add-icon-wrapper group-hover:bg-[#4338CA] group-hover:text-white">
...
function LoadingSkeleton() {
    return (
        <div className="skeleton-container">
            ...
            <p className="skeleton-text">플래니가 생각 중...</p>
        </div>
    );
}
